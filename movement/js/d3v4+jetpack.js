...
(function (global, factory) {
  ...
  function stack() {
    ...
    stack.keys = function (_) {
      return arguments.length
        ? ((keys = typeof _ === 'function' ? _ : constant$1(slice$2.call(_))),
          stack)
        : keys;
    };
  ...
  function continuous(deinterpolate$$, reinterpolate) {
    ...
    scale.rangeRound = function (_) {
      return (
        (range = slice$3.call(_)), (interpolate$$ = interpolateRound), rescale()
      );
    };
  ...
  function transition_style(name, value, priority) {
    var i =
      (name += '') === 'transform' ? interpolateTransform$1 : interpolate$1;
    return value == null
  ...
  function index() {
    ...
    pack.padding = function (x) {
      return arguments.length
        ? ((padding = typeof x === 'function' ? x : constant$5(+x)), pack)
        : padding;
    };
  ...
  function index$1() {
    ...
    treemap.paddingInner = function (x) {
      return arguments.length
        ? ((paddingInner = typeof x === 'function' ? x : constant$5(+x)),
          treemap)
        : paddingInner;
    };
    ...
    treemap.paddingTop = function (x) {
      return arguments.length
        ? ((paddingTop = typeof x === 'function' ? x : constant$5(+x)), treemap)
        : paddingTop;
    };

    treemap.paddingRight = function (x) {
      return arguments.length
        ? ((paddingRight = typeof x === 'function' ? x : constant$5(+x)),
          treemap)
        : paddingRight;
    };
    ...
    treemap.paddingBottom = function (x) {
      return arguments.length
        ? ((paddingBottom = typeof x === 'function' ? x : constant$5(+x)),
          treemap)
        : paddingBottom;
    };
  ...
  function collide(radius) {
    ...
    force.radius = function (_) {
      return arguments.length
        ? ((radius = typeof _ === 'function' ? _ : constant$6(+_)), force)
        : radius;
    };
  ...
  function drag() {
    ...
    drag.filter = function (_) {
      return arguments.length
        ? ((filter = typeof _ === 'function' ? _ : constant$7(!!_)), drag)
        : filter;
    };

    drag.container = function (_) {
      return arguments.length
        ? ((container = typeof _ === 'function' ? _ : constant$7(_)), drag)
        : container;
    };

    drag.subject = function (_) {
      return arguments.length
        ? ((subject = typeof _ === 'function' ? _ : constant$7(_)), drag)
        : subject;
    };
  ...
  function zoom() {
    ...
    zoom.filter = function (_) {
      return arguments.length
        ? ((filter = typeof _ === 'function' ? _ : constant$9(!!_)), zoom)
        : filter;
    };
  ...
  function brush$1(dim) {
    ...
    brush.filter = function (_) {
      return arguments.length
        ? ((filter = typeof _ === 'function' ? _ : constant$10(!!_)), brush)
        : filter;
    };
  ...
  function circle$1() {
    ...
    circle.center = function (_) {
      return arguments.length
        ? ((center = typeof _ === 'function' ? _ : constant$11([+_[0], +_[1]])),
          circle)
        : center;
    };
    ...
    circle.radius = function (_) {
      return arguments.length
        ? ((radius = typeof _ === 'function' ? _ : constant$11(+_)), circle)
        : radius;
    };

    circle.precision = function (_) {
      return arguments.length
        ? ((precision = typeof _ === 'function' ? _ : constant$11(+_)), circle)
        : precision;
    };
  ...
  function conicConformalRaw(y0, y1) {
    var cy0 = cos(y0),
      n =
        y0 === y1 ? sin(y0) : log$1(cy0 / cos(y1)) / log$1(tany(y1) / tany(y0)),
  ...
  function selection_styles(map, priority) {
    return (
      typeof map === 'function' ? stylesFunction : stylesObject
  ...
  function selection_properties(map) {
    return (
      typeof map === 'function' ? propertiesFunction : propertiesObject
    )(this, map);
  }
  ...
  function transition_attrs(map) {
    return (
      typeof map === 'function' ? attrsFunction$1 : attrsObject$1
    )(this, map);
  }
  ...
  function transition_styles(map, priority) {
    return (
      typeof map === 'function' ? stylesFunction$1 : stylesObject$1
    )(this, map, priority == null ? '' : priority);
  }
  ...
  function conventions(c) {
    ...
    c.height =
      c.height || c.totalHeight - c.margin.top - c.margin.bottom || 460;
  ...
  function attachTooltip(sel, tooltipSel, fieldFns) {
    ...
    sel
      ...
      .on('click.attachTooltip', function (d) {
        console.log(d);
      });
    ...
    function ttMove(d) {
      ...
      tt.style(
        'left',
        Math.min(
          Math.max(20, x - nBB.width / 2),
          window.innerWidth - nBB.width - 20
        ) + 'px'
      );
    }
