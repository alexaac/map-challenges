...
!(function (t, n) {
    ...
    Zn(Kn, {
      ...
      rgb: function () {
        ...
        return new _e(
          ...
          Ie(-0.9787684 * n + 1.9161415 * t + 0.033454 * e),
          Ie(0.0719453 * n - 0.2289914 * t + 1.4052427 * e),
          this.opacity
        );
      },
    })
    ...
    function h(e) {
      ...
      function U(t) {
        for (const n of t.changedTouches || [t])
          for (const t of D)
            t.identifier === n.identifier && (t.cur = Un(n, _));
        if (z && !y && !v && 1 === D.length) {
          const t = D[0];
  ...
  class Fa {
    ...
    update() {
      ...
      for (let o, a, u = 0; u < this._ids.length; u++) {
        ...
        for (
          ;
          (g = e[y]), !Ia(f, s, t[2 * y], t[2 * y + 1], t[2 * g], t[2 * g + 1]);
        ...
        for (
          ;
          (g = e[_]), Ia(f, s, t[2 * _], t[2 * _ + 1], t[2 * g], t[2 * g + 1]);
        ...
        if (y === l)
          for (
            ;
            (g = n[y]),
              Ia(f, s, t[2 * g], t[2 * g + 1], t[2 * y], t[2 * y + 1]);
  ...
  function Ia(t, n, e, r, i, o) {
    return (
      (Ua(i, o, t, n, e, r) || Ua(t, n, e, r, i, o) || Ua(e, r, i, o, t, n)) < 0
    );
  }
  ...
  (Xu.copy = function () {
    ...
    (Xu.visit = function (t) {
      var n,
        ...
        c = this._root;
      for (
        c && u.push(new Iu(c, this._x0, this._y0, this._x1, this._y1));
        (n = u.pop());
        ...
        if (
          ...
          var f = (r + o) / 2,
            s = (i + a) / 2;
          (e = c[3]) && u.push(new Iu(e, f, s, o, a)),
            (e = c[2]) && u.push(new Iu(e, r, s, f, a)),
            (e = c[1]) && u.push(new Iu(e, f, i, o, s)),
            (e = c[0]) && u.push(new Iu(e, r, i, f, s));
        }
      return this;
    }),
    (Xu.visitAfter = function (t) {
      ...
      for (
        this._root &&
        e.push(new Iu(this._root, this._x0, this._y0, this._x1, this._y1));
        (n = e.pop());
        ...
        if (i.length) {
          var o,
            ...
            s = (a + c) / 2,
            l = (u + f) / 2;
          (o = i[0]) && e.push(new Iu(o, a, u, s, l)),
            (o = i[1]) && e.push(new Iu(o, s, u, c, l)),
            (o = i[2]) && e.push(new Iu(o, a, l, s, f)),
            (o = i[3]) && e.push(new Iu(o, s, l, c, f));
        }
        r.push(n);
      }
    ...
    return function (a) {
      ...
      function M(o, a) {
        ...
        if ((f && s.push([o, a]), v))
          ...
          var c = [
              (p = Math.max(Us, Math.min(Os, p))),
              (g = Math.max(Us, Math.min(Os, g))),
            ],
            m = [
              (o = Math.max(Us, Math.min(Os, o))),
              (a = Math.max(Us, Math.min(Os, a))),
            ];
    ...
    return (
      ...
      e &&
        ((i.count = function (n, r) {
          return (
            Up.setTime(+n), Ip.setTime(+r), t(Up), t(Ip), Math.floor(e(Up, Ip))
          );
        }),
        (i.every = function (t) {
          return (
  ...
  function Wg(t) {
    ...
    function M(t, n) {
      return function (e) {
        ...
        return "Z" in o
          ? ((o.H += (o.Z / 100) | 0), (o.M += o.Z % 100), Vg(o))
          : Gg(o);
      };
    }
    function A(t, n, e, r) {
      for (var i, o, a = 0, u = n.length, c = e.length; a < u; ) {
        ...
        if (37 === (i = n.charCodeAt(a++))) {
          if (
            ((i = n.charAt(a++)),
            !(o = x[i in Kg ? n.charAt(a++) : i]) || (r = o(t, e, r)) < 0)
          )
            return -1;
  ...
  function jy(t, n) {
    var e = t.getDay();
    return ny(
      (t = e >= 4 || 0 === e ? ug(t) : ug.ceil(t)).getFullYear() % 1e4,
      n,
      4
    );
  }
  ...
  function rv(t, n) {
    return (
      (t = ev(t)), ny(zg.count(Hg(t), t) + (4 === Hg(t).getUTCDay()), n, 2)
    );
  }
  function iv(t) {
    return t.getUTCDay();
  ...
  function fv(t, n) {
    var e = t.getUTCDay();
    return ny(
      (t = e >= 4 || 0 === e ? zg(t) : zg.ceil(t)).getUTCFullYear() % 1e4,
      n,
      4
    );
  }
  ...
  function pv(n) {
    return (
      (Zg = Wg(n)),
      (t.timeFormat = Zg.format),
      (t.timeParse = Zg.parse),
      (t.utcFormat = Zg.utcFormat),
      (t.utcParse = Zg.utcParse),
      Zg
    );
  }
  (t.timeFormat = void 0),
  ...
  var yv = Date.prototype.toISOString
    ...
    : t.utcFormat(gv);
  var vv = +new Date("2000-01-01T00:00:00.000Z")
      ? function (t) {
          var n = new Date(t);
  ...
  var Dv = zv("1f77b4ff7f0e2ca02cd627289467bd8c564be377c27f7f7fbcbd2217becf"),
    ...
    L_ = new Array(3)
      ...
      .map(zv),
    j_ = jv(L_);
  var H_ = Lr(tr(300, 0.5, 0), tr(-240, 0.5, 1)),
    X_ = Lr(tr(-100, 0.75, 0.35), tr(80, 1.5, 0.8)),
    G_ = Lr(tr(260, 0.75, 0.35), tr(80, 1.5, 0.8)),
    V_ = tr();
  var $_ = ve(),
    W_ = Math.PI / 3,
    Z_ = (2 * Math.PI) / 3;
  ...
  function Nb(t, n) {
    ...
    return (
      (t = "function" == typeof t ? t : void 0 === t ? Eb : eb(t)),
      (n = "function" == typeof n ? n : void 0 === n ? kb : eb(n)),
      (a.x = function (n) {
        return arguments.length
          ? ((t = "function" == typeof n ? n : eb(+n)), a)
          : t;
      }),
      (a.y = function (t) {
        return arguments.length
          ? ((n = "function" == typeof t ? t : eb(+t)), a)
          : n;
      }),
      (a.defined = function (t) {
        return arguments.length
          ? ((e = "function" == typeof t ? t : eb(!!t)), a)
          : e;
      }),
      (a.curve = function (t) {
  ...
  function Cb(t, n, e) {
    ...
    return (
      (t = "function" == typeof t ? t : void 0 === t ? Eb : eb(+t)),
      (n = "function" == typeof n ? n : eb(void 0 === n ? 0 : +n)),
      (e = "function" == typeof e ? e : void 0 === e ? kb : eb(+e)),
      (c.x = function (n) {
        return arguments.length
          ? ((t = "function" == typeof n ? n : eb(+n)), (r = null), c)
          : t;
      }),
      (c.x0 = function (n) {
        return arguments.length
          ? ((t = "function" == typeof n ? n : eb(+n)), c)
          : t;
      }),
      (c.x1 = function (t) {
        return arguments.length
          ? ((r = null == t ? null : "function" == typeof t ? t : eb(+t)), c)
          : r;
      }),
      (c.y = function (t) {
        return arguments.length
          ? ((n = "function" == typeof t ? t : eb(+t)), (e = null), c)
          : n;
      }),
      (c.y0 = function (t) {
        return arguments.length
          ? ((n = "function" == typeof t ? t : eb(+t)), c)
          : n;
      }),
      (c.y1 = function (t) {
        return arguments.length
          ? ((e = null == t ? null : "function" == typeof t ? t : eb(+t)), c)
          : e;
      }),
  ...
  function Lb(t) {
    ...
    return (
      ...
      (a.x = function (t) {
        return arguments.length
          ? ((r = "function" == typeof t ? t : eb(+t)), a)
          : r;
      }),
      (a.y = function (t) {
        return arguments.length
          ? ((i = "function" == typeof t ? t : eb(+t)), a)
          : i;
      }),
      (a.context = function (t) {
    ...
    cm = {
      draw: function (t, n) {
        ...
        t.moveTo(r, i),
          t.lineTo(o, a),
          t.lineTo(u, c),
          t.lineTo(im * r - om * i, om * r + im * i),
          t.lineTo(im * o - om * a, om * o + im * a),
          t.lineTo(im * u - om * c, om * u + im * c),
          t.lineTo(im * r + om * i, im * i - om * r),
          t.lineTo(im * o + om * a, im * a - om * o),
          t.lineTo(im * u + om * c, im * c - om * u),
          t.closePath();
      },
    },
  ...
  function qm(t, n, e) {
    var r = t._x1 - t._x0,
      ...
      u = (o * i + a * r) / (r + i);
    return (
      (Dm(o) + Dm(a)) * Math.min(Math.abs(o), Math.abs(a), 0.5 * Math.abs(u)) ||
      0
    );
  }
  function Rm(t, n) {
      ...
      lineEnd: function () {
        ...
        if (e)
          if (
            ...
            for (var r = Ym(t), i = Ym(n), o = 0, a = 1; a < e; ++o, ++a)
              this._context.bezierCurveTo(
                r[0][o],
                i[0][o],
                r[1][o],
  ...
  var Km = (t) => () => t;
  function Qm(t, { sourceEvent: n, target: e, transform: r, dispatch: i }) {
    Object.defineProperties(this, {
      type: { value: t, enumerable: !0, configurable: !0 },
      sourceEvent: { value: n, enumerable: !0, configurable: !0 },
      target: { value: e, enumerable: !0, configurable: !0 },
  ...
  Jm.prototype = {
    ...
    translate: function (t, n) {
      return (0 === t) & (0 === n)
        ? this
        : new Jm(this.k, this.x + this.k * t, this.y + this.k * n);
    },
    apply: function (t) {
  ...
  var tx = new Jm(1, 0, 0);
  function nx(t) {
    for (; !t.__zoom; ) if (!(t = t.parentNode)) return tx;
    return t.__zoom;
  }
  function ex(t) {
    t.stopImmediatePropagation();
  ...
  (nx.prototype = Jm.prototype),
    ...
    (t.arc = function () {
      ...
      function c() {
        ...
        if ((u || (u = c = fa()), l < s && ((f = l), (l = s), (s = f)), l > sb))
          if (p > db - sb)
            u.moveTo(l * ob(h), l * cb(h)),
              u.arc(0, 0, l, h, d, !g),
              s > sb &&
                (u.moveTo(s * ob(d), s * cb(d)), u.arc(0, 0, s, d, h, g));
          else {
            var y,
              v,
              _ = h,
                  ...
                  k < S
                    ...
                    : (u.arc(
                      ...
                      u.arc(
                        ...
                        0,
                        l,
                        ib(y.cy + y.y11, y.cx + y.x11),
                        ib(v.cy + v.y11, v.cx + v.x11),
                        !g
                      ),
                      u.arc(
                        v.cx,
      ...
      return (
        ...
        (c.endAngle = function (t) {
          return arguments.length
            ? ((o = "function" == typeof t ? t : eb(+t)), c)
            : o;
        }),
        (c.padAngle = function (t) {
          return arguments.length
            ? ((a = "function" == typeof t ? t : eb(+t)), c)
            : a;
        }),
        (c.context = function (t) {
    ...
    (t.curveBundle = vm),
    (t.curveCardinal = mm),
    (t.curveCardinalClosed = wm),
    (t.curveCardinalOpen = Am),
    (t.curveCatmullRom = Em),
    (t.curveCatmullRomClosed = Nm),
    (t.curveCatmullRomOpen = Pm),
    (t.curveLinear = Sb),
    ...
    (t.interpolateBlues = D_),
    (t.interpolateBrBG = Xv),
    (t.interpolateBuGn = f_),
    ...
    (t.interpolateCool = G_),
    (t.interpolateCubehelix = Yr),
    (t.interpolateCubehelixDefault = H_),
    ...
    (t.interpolateGnBu = d_),
    (t.interpolateGreens = R_),
    (t.interpolateGreys = O_),
    (t.interpolateHcl = Ur),
    (t.interpolateHclLong = Ir),
    (t.interpolateHsl = Rr),
    ...
    (t.interpolateMagma = J_),
    (t.interpolateNumber = _r),
    (t.interpolateNumberArray = pr),
    (t.interpolateObject = br),
    (t.interpolateOrRd = g_),
    (t.interpolateOranges = j_),
    (t.interpolatePRGn = Vv),
    (t.interpolatePiYG = Wv),
    (t.interpolatePlasma = nb),
    (t.interpolatePuBu = b_),
    (t.interpolatePuBuGn = v_),
    (t.interpolatePuOr = Kv),
    (t.interpolatePuRd = x_),
    (t.interpolatePurples = I_),
    ...
    (t.interpolateRdBu = Jv),
    (t.interpolateRdGy = n_),
    (t.interpolateRdPu = M_),
    (t.interpolateRdYlBu = r_),
    (t.interpolateRdYlGn = o_),
    (t.interpolateReds = Y_),
    (t.interpolateRgb = sr),
    ...
    (t.interpolateSinebow = function (t) {
      ...
      return (
        (t = (0.5 - t) * Math.PI),
        ($_.r = 255 * (n = Math.sin(t)) * n),
        ($_.g = 255 * (n = Math.sin(t + W_)) * n),
        ($_.b = 255 * (n = Math.sin(t + Z_)) * n),
        $_ + ""
      );
    }),
    (t.interpolateSpectral = u_),
    ...
    (t.interpolateViridis = Q_),
    (t.interpolateWarm = X_),
    (t.interpolateYlGn = E_),
    (t.interpolateYlGnBu = T_),
    (t.interpolateYlOrBr = N_),
    (t.interpolateYlOrRd = P_),
    ...
    (t.scaleTime = function () {
      return rp.apply(
        Sv(bg, vg, rg, tg, Qp, Zp, $p, Yp, t.timeFormat).domain([
          new Date(2e3, 0, 1),
          new Date(2e3, 0, 2),
        ]),
        arguments
    ...
    (t.scaleUtc = function () {
      return rp.apply(
        Sv(Hg, Lg, kg, Tg, Mg, xg, $p, Yp, t.utcFormat).domain([
          Date.UTC(2e3, 0, 1),
          Date.UTC(2e3, 0, 2),
        ]),
        arguments
    ...
    (t.stack = function () {
      ...
      return (
        (i.keys = function (n) {
          return arguments.length
            ? ((t = "function" == typeof n ? n : eb(Array.from(n))), i)
            : t;
        }),
        (i.value = function (t) {
          return arguments.length
            ? ((r = "function" == typeof t ? t : eb(+t)), i)
            : r;
        }),
        (i.order = function (t) {
          return arguments.length
    ...
    (t.stackOrderAppearance = Vm),
    (t.stackOrderAscending = Wm),
    ...
    (t.symbol = function (t, n) {
      ...
      return (
        (t = "function" == typeof t ? t : eb(t || Gb)),
        (n = "function" == typeof n ? n : eb(void 0 === n ? 64 : +n)),
        (r.type = function (n) {
          return arguments.length
            ? ((t = "function" == typeof n ? n : eb(n)), r)
            : t;
        }),
        (r.size = function (t) {
          return arguments.length
            ? ((n = "function" == typeof t ? t : eb(+t)), r)
            : n;
        }),
    ...
    (t.timeDay = tg),
    (t.timeDays = ng),
    (t.timeFormatDefaultLocale = pv),
    (t.timeFormatLocale = Wg),
    (t.timeFriday = cg),
    (t.timeFridays = gg),
    (t.timeHour = Qp),
    (t.timeHours = Jp),
    ...
    (t.zoom = function () {
      ...
      function A(t, ...n) {
        ...
        function h(t) {
          ...
          i.event(t).zoom(
            "mouse",
            o(
              _(i.that.__zoom, (i.mouse[0] = Un(t, c)), i.mouse[1]),
              i.extent,
              f
            )
          );
      ...
      function k(t, ...r) {
        if (this.__zooming) {
          ...
          if (
            ...
            (a.end(),
            2 === a.taps &&
              ((o = Un(o, this)), Math.hypot(n[0] - o[0], n[1] - o[1]) < g))
          ) {
      ...
      return (
        ...
        (y.wheelDelta = function (t) {
          return arguments.length
            ? ((a = "function" == typeof t ? t : Km(+t)), y)
            : a;
        }),
        (y.filter = function (t) {
          return arguments.length
            ? ((r = "function" == typeof t ? t : Km(!!t)), y)
            : r;
        }),
        (y.touchable = function (t) {
          return arguments.length
            ? ((u = "function" == typeof t ? t : Km(!!t)), y)
            : u;
        }),
        (y.extent = function (t) {
          return arguments.length
